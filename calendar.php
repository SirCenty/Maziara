        ...
        <div class="inner shadow">
            ...
            <div id="footer">
            	<div class="foot-top">
                	<!-- Footer Logo Start -->
                    <div class="logo-foot">
                    	<a href="calendar.php#"><img src="images/logo-foot.png" alt="" /></a>
                    </div>
                    <!-- Footer Logo End -->
                ...
                <div class="foot-bottom">
                    ...
                    <div class="followus-top">
                    	...
                    	<ul>
                            ...
                            <li><a href="calendar.php#" class="vimeo">&nbsp;</a></li>
                            <li><a href="calendar.php#" class="amazon">&nbsp;</a></li>
                            <li><a href="calendar.php#" class="apple">&nbsp;</a></li>
                            <li><a href="calendar.php#" class="grooveshark">&nbsp;</a></li>
                            <li><a href="calendar.php#" class="soundcloud">&nbsp;</a></li>
                        </ul>
                        <!-- Follow Us End -->
                    </div>
