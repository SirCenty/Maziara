                ...
                <div class="foot-bottom">
                    ...
                    <div class="followus-top">
                    	...
                    	<ul>
                            ...
                            <li><a href="index.php#" class="vimeo">&nbsp;</a></li>
                            <li><a href="index.php#" class="amazon">&nbsp;</a></li>
                            <li><a href="index.php#" class="apple">&nbsp;</a></li>
                            <li><a href="index.php#" class="grooveshark">&nbsp;</a></li>
                            <li><a href="index.php#" class="soundcloud">&nbsp;</a></li>
                        </ul>
                        <!-- Follow Us End -->
                    </div>
